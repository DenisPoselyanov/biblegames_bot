...
/**
 * A word plus a `?` that explains it where it stands. The studio may use a word
...
export function Textarea(props: ComponentPropsWithoutRef<'textarea'>) {
  return <textarea {...props} className={cn(CONTROL, 'h-auto py-2', props.className)} />;
}
